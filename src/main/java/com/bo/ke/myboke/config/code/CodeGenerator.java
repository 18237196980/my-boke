package com.bo.ke.myboke.config.code;
...
public class CodeGenerator {
    ...
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/my-boke?useUnicode=true&useSSL=false&characterEncoding=utf8";
    private static final String JDBC_USER_NAME = "root";
    private static final String JDBC_PASSOWRD = "root";

    // 包名和模块名
    private static final String PACKAGE_NAME = "com.bo.ke";
    private static final String MODULE_NAME = "myboke";

    // 表名，多个表使用英文逗号分割
    private static final String TBL_NAMES = "m_blog";
